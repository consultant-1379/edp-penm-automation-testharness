...
cmd="python /opt/ericsson/firmwareupgradetool/firmware_upgrade.py --nas --sedfile='/opt/ericsson/firmwareupgradetool/template/my_template' --username='root' --noreboot --force"
